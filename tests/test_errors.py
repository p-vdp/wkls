...
def test_nonexistent_location_errors():
    ...
    # Nonexistent country
    try:
        result = wkls.zz  # ZZ is not a valid country code, should return empty DataFrame
    ...
    # Nonexistent region
    try:
        result = wkls.us.zz  # ZZ is not a valid state code, should return empty DataFrame  
