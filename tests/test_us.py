...
def test_access():
    ...
    assert(wkls.us.ny.cityofnewyork.wkt().startswith("MULTIPOLYGON (((-74.046176 40.691092"))
    assert(wkls.us.ca.sanfrancisco.wkt().startswith("MULTIPOLYGON (((-122.9915659 37.7672733"))
    ...
    assert len(san_francisco_results) == 2, "San Francisco search should return exactly two results"
